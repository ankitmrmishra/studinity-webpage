...
function HerosectionLeftPart() {
  return (
    <div className='lg:w-[80rem] w-full '>
      ...
      <div className='this-is-search-bar bg-white justify-between lg:w-[25rem] mt-10 w-[18rem] items-center align-middle text-slate-600 flex flex-row p-2 rounded-lg'>
